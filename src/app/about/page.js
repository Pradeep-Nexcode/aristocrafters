...
//                 { label: "Expert Mentorship", icon: "🤝" },
//                 { label: "Innovative Teaching", icon: "💡" },
//                 { label: "Student Success Focus", icon: "🚀" },
//               ].map((stat, index) => (
//                 <div key={index} className="group">
//                   <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2">
...
//         <div className="container mx-auto px-4">
//           <div className="max-w-4xl mx-auto text-center">
//             <div className="bg-white/80 backdrop-blur-md rounded-3xl p-12 border border-white/20 shadow-md">
