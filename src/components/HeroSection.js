...
import { FaCheckCircle, FaGraduationCap, FaUsers, FaClock, FaRupeeSign, FaBookOpen, FaChalkboardTeacher, FaStar, FaChartLine, FaBullseye } from 'react-icons/fa';
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh]">
          ...
          <div className="lg:w-1/2 mb-12 lg:mb-0 z-10">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-tight max-w-lg font-nunito">
              Personalized coaching for Classes 5th to 10th in Tamil, English, Maths, Science & Social Science.
            </p>
            ...
            <div className="flex items-center gap-6 mb-8">
              <div className="flex items-center gap-2 text-gray-700">
                ...
                <span className="text-sm font-medium font-nunito">Expert Tutors</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <FaUsers className="text-green-600 text-xl" />
                <span className="text-sm font-medium font-nunito">Small Batches</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <FaRupeeSign className="text-purple-600 text-xl" />
                <span className="text-sm font-medium font-nunito">Affordable Fees</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
               ...
               className="group relative px-10 py-4  cursor-pointer bg-blue-600 text-white rounded-2xl font-semibold hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-nunito">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900 font-poppins">Live Session</div>
                      <div className="text-sm text-gray-500 font-nunito">Mathematics</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></span>
                    <span className="text-sm text-gray-600 font-nunito">Online</span>
                  </div>
                </div>
                
                <div className="bg-gray-50 rounded-2xl p-6 mb-6">
                  <div className="text-2xl font-bold text-gray-900 mb-2 font-poppins">Quadratic Equations</div>
                  <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
                    <div className="bg-blue-600 h-2 rounded-full" style={{width: '75%'}}></div>
                  </div>
                  <div className="text-sm text-gray-600 font-nunito">Progress: 75% Complete</div>
                </div>
