...
const SubjectsSection = () => {
  ...
  return (
    <>
      <section
        id="subjects"
        className="myPadY bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden"
      >
        {/* Background Elements */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive curriculum coverage for classes 2-5 with
              personalized learning paths and interactive sessions
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-10">
              {subjects.slice(0, 4).map((subject, index) => {
                ...
                <div className="flex items-center gap-1 text-xs font-medium">
                  ...
                  <span className="text-blue-600">{subject.students}</span>
                </div>
              </div> */}
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1">
                      <div className="flex items-center gap-1 text-xs font-medium">
                        ...
                        <span className="text-blue-600">{subject.rating}</span>
                      </div>
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                      ...
                      <div className="flex items-center justify-center">
                        <button
                          ...
                          className=" relative cursor-pointer overflow-hidden px-6 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl font-semibold border border-white/30 hover:bg-white/30 transition flex items-center justify-center gap-2 group"
                        >
